...
public class Triangle extends Application{
	...
	private Pane pane;
	double point1x = 650.0, point1y = 300.0;
	double point2x = 300.0, point2y = 530.0;
	double point3x = 300.0, point3y = 70.0;
	double a = 0, b = 0, c = 0;
...
//===============================adding degrees of angle as a text========================//
		...
		pane=new Pane();
		pane.getChildren().addAll(line1, line2, line3, c1, c2, c3, cir1, txt1, txt2, txt3);
