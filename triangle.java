...
//	    connection = new Line();
//	    connection.startXProperty().bind(handle2.centerXProperty());
//	    connection.startYProperty().bind(handle2.centerYProperty());
//	    connection.endXProperty().bind(handle1.centerXProperty());
//	    connection.endYProperty().bind(handle1.centerYProperty());
...
//	    		line3 = new Line(c3.getCenterX(), c3.getCenterY(), c1.getCenterX(), c1.getCenterY());
	  ...
	  //===========================calculating length of each line using the center circle points======//
	    		...
	    		//================calculating angles using the lengths, then converting from rad to deg==========//
	    				...
	    				System.out.println("ang1 = " + decform.format(ang1));
	    				System.out.println("ang2 = " + decform.format(ang2));
	    				System.out.println("ang3 = " + decform.format(ang3));
				...
				return new Group(line1, line2, line3, c1, c2, c3, txt1, txt2, txt3);
	        }
